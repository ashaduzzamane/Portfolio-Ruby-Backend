class Api::V1::PropertiesController < ApplicationController
    ...
    def property_params
        params.permit(:propertyAddress, :propertyType, :propertyPrice, :propertyDownPayment, :propertyClosingCosts, :propertyRehabCosts, :propertyPrinciple, :propertyRent, :propertyTotalRevenue, :propertyMortgage, :propertyTaxes, :propertyInsurance, :propertyMiscExpenses, :propertyCashflow, :propertyCashOnCash, :propertyInternalRate)
    end
end
